                ...
                <div className='lg:flex lg:justify-between xl:gap-0 lg:gap-6'>
                    <div className='w-96 animate__animated animate__fadeInLeft'>
                        ...
                        <div className='mt-8'>
                            ...
                            <div className='text-xl text-white mt-4 space-x-6 animation-translateA'>
                    ...
                    <div className='flex justify-center items-center mr-10 animate__animated animate__fadeInRight xl:p-10 lg:p-6 lg:bg-[rgb(30,41,57)] rounded-2xl'>
                        <form action="submit" className="flex justify-center items-center flex-col md:ml-0 ml-10">
                            ...
                            <button className='flex items-center gap-2 mt-4 px-6 py-3 text-white text-md font-bold border-none rounded-xl bg-teal-600 hover:bg-teal-700 shadow-2xl transition-all transform duration-700 group hover:scale-105'>Send Message<BsSendFill className="group-hover:translate-x-2 transition-all transform duration-700"/></button>
                        </form>
                    </div>
                </div>
            </div>
